                    ...
                    <>
                        <ModalHeader className="flex-col items-center justify-center gap-2">
                            ...
                            <p className="text-sm font-normal mb-2">Hi 👋 this is Alex, the solo founder of Sheets to
                                ...
                                entirely free.</p>
                            <p className="text-sm font-normal"><span className="font-semibold">There are paid tiers, but there will always be a freemium
                                    ...
                                    <Card shadow="none" className="w-full border-medium p-2 gap-3"
                                        ...
                                        <CardFooter>
                                            {value === PricingTier.Free ? (
                                                ...
                                                <Button radius="md" className="text-base font-medium" color="primary"
                                                        fullWidth size="lg">
                                                    Select
                                                </Button>
                                            )}
